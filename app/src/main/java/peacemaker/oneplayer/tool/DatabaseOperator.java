...
//        editor.commit();
    ...
    public static OneConfig loadConfig(Context context){
        ...
        oneConfig.setBlurRadius(sharedPreferences.getInt("blurRadius",5));
        ...
        range[0] = (short)sharedPreferences.getInt("minEQLevel",0);
        range[1] = (short)sharedPreferences.getInt("maxEQLevel",0);
        oneConfig.setBandLevelRange(range);
        LogTool.log("DatabaseOperator","loadConfig()"+oneConfig.getBlurRadius());
    ...
    public static void saveConfig(OneConfig oneConfig,Context context){
        ...
        editor.putInt("minEQLevel",oneConfig.getBandLevelRange()[0]);
        editor.putInt("maxEQLevel",oneConfig.getBandLevelRange()[1]);
        editor.putInt("blurRadius",oneConfig.getBlurRadius());
        LogTool.log("DatabaseOperator","saveConfig()"+oneConfig.getBlurRadius());
        editor.apply();
    }
