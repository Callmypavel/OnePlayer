...
public class OneAblumListFragment extends Fragment {
    ...
    public void onActivityCreated(@Nullable Bundle savedInstanceState) {
        ...
        oneAlbumItemAdapter = new OneAlbumItemAdapter(oneApplication.getAblumArrayList());
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.one_ablumlist_fragment,container,false);
    ...
    public class OneAlbumItemAdapter extends RecyclerView.Adapter<OneAblumViewHolder>{
        ...
        @Override
        public OneAblumViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            Log.v("OneAblumListFragment","onCreateViewHolder()");
            OneAblumViewHolder oneViewHolder = OneAblumViewHolder.createHolder(LayoutInflater.from(parent.getContext()),parent);
            return oneViewHolder;
        }

        @Override
        public void onBindViewHolder(final OneAblumViewHolder holder, final int position) {
